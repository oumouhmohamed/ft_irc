...
** Supported flags: i t k o l
** Without a mode string, replies with the channel's current modes (324).
*/
void Server::handl_Mode(int fd, const Message &msg)
{
	...
	size_t arg_index = 2;      // next argument to consume from msg.params
	char   sign = '+';
